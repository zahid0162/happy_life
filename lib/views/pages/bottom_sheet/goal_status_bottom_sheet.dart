...
class GoalStatusBotttomSheet extends StatefulWidget {
  GoalTypes? selectedType;

  GoalStatusBotttomSheet({super.key, this.selectedType});

  @override
  State createState() => _CountrySelectorBottomSheetState();
}

class _CountrySelectorBottomSheetState extends State<GoalStatusBotttomSheet> {
  @override
  void initState() {
    super.initState();
  }
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomText(
                  text: AppConstants.setGoalStatus,
              ...
              Container(
                padding: EdgeInsets.symmetric(
                    vertical: Spacing.xxxxlarge, horizontal: Spacing.standard),
                decoration: BoxDecoration(
  ...
  Widget gendersView(StateSetter setModalState) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          singleGender(GoalTypes.ACTIVE,setModalState),
          singleGender(GoalTypes.COMPLETED, setModalState),
          singleGender(GoalTypes.GIVEUP, setModalState)
        ],
      ),
    );
  }

  Widget singleGender(GoalTypes type,StateSetter setModalState){
    return GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(vertical: Spacing.normal, horizontal: Spacing.xxxlarge + 2),
        decoration: BoxDecoration(
        ...
        child: CustomText(
          text: type.name,
          textColor: widget.selectedType == type
